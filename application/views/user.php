  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <form class="navbar-form navbar-left" role="search" action='<?php echo site_url('users');?>' method='get'>
        ...
        <?php foreach ($users as $user) { ?>
          ...
          <div class='col-xs-6 col-sm-4 col-md-3'>
            <div class='thumbnail'>
              ...
              <div class='caption'>
                <p><?php echo $user->account."($user->name)"; ?></p>
                <hr>

                <p class='text-right'></p>
                  <?php if($user->get_friend){ ?>
                    <p class='text-right'><a href='<?php echo  site_url("users/delete_friends?friend_id=$user->id"); ?>' class='btn btn-danger' role='button'>刪除好友</a></p>
                  <?php }else {?>
                    <p class='text-right'><a href='<?php echo site_url("users/insert_friends?friend_id=$user->id"); ?>' class='btn btn-primary' role='button'>加入好友</a></p>
                  <?php } ?>
